...
interface AlertContextType {
  ...
  showAlert: (title: string, message: string, showCancelButton: boolean) => Promise<boolean>;
...
export const AlertProvider  = ({ children }: Props) => {
    const [alert, setAlert] = useState({ visible: false, title: '', message: '', resolve: (result: boolean) => {}, showCancelButton: true });

    /************************************************
     * カスタム通知呼び出し関数
     ************************************************/
    const showAlert = (title: string, message: string, showCancelButton: boolean): Promise<boolean> => {
