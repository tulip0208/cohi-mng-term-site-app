...
import {WA1091BackState,WA1090PrevScreenId,WA1090NewTagIdState,WA1091OldTagInfoState,WA1093MemoState } from "../atom/atom.tsx";
    ...
    return (
      ...
      >
        <ScrollView  contentContainerStyle={[styles.containerWithKeybord, { flexGrow: 1 }]}>
          ...
          {/* ヘッダ */}
          <FunctionHeader appType={"現"} viewTitle={"メモ入力"} functionTitle={"紐付(灰)"}/>
