...
const WA1030 = ({navigation}:Props) => {
    ...
    return (
      <View style={styles.container}>
        {/* ヘッダ */}
        <TapFunctionHeader appType={"現"} viewTitle={"ログイン"} functionTitle={""} sourceScreenId={"WA1030"}/>
        ...
        <View  style={[styles.main,styles.topContent]}>
          ...
          <TouchableOpacity style={[styles.button,styles.buttonRead]} onPress={btnWkplac}>
