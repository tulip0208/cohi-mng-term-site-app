...
import { WA1120DataState,WA1120PrevScreenId, WA1120CarState, WA1120DrvState, WA1120DestState, WA1120TrpCardNoState, WA1121DataState, } from "../atom/atom.tsx";
...
const WA1123 = ({navigation}:Props) => {
    ...
    return (
      <View style={styles.container}>
          {/* ヘッダ */}
          <FunctionHeader appType={"現"} viewTitle={"申請結果表示"} functionTitle={"輸送(申)"}/>
        ...
        <View  style={[styles.textareaContainer,styles.topContent]}>
          ...
          <View  style={[styles.textareaContainer,styles.topContent]}>
            <View style={styles.tableMain}>
              <View style={styles.tableRow}>
                <View style={styles.tableCell}><Text style={[styles.labelTextNarrow,styles.alignRight]}>申請状況：</Text></View>
