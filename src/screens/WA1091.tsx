...
import {WA1091BackState,WA1090PrevScreenId,WA1090NewTagIdState,WA1090WkPlacState,WA1091OldTagInfoState } from "../atom/atom.tsx";
...
const WA1091 = ({navigation}:Props) => {
    ...
    const [WA1091OldTagInfo,setWA1091OldTagInfo] = useRecoilState(WA1091OldTagInfoState);
    ...
    return (
      ...
      >
        <ScrollView  contentContainerStyle={[styles.containerWithKeybord, { flexGrow: 1 }]}>
          ...
          {/* ヘッダ */}
          <FunctionHeader appType={"現"} viewTitle={"旧タグ入力"} functionTitle={"紐付(灰)"}/>
