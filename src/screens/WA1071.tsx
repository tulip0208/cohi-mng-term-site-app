...
const WA1071 = ({navigation}:Props) => {
      ...
      return(
        <View style={styles.tableMain}>
          <View style={styles.tableRow}>
            ...
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0007[WA1070Data?.data.rmSolTyp as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>特定施設：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0006[WA1070Data?.data.splFac as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>津波浸水：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0005[WA1070Data?.data.tsuInd as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>重量：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{WA1070Data?.data.caLgSdBgWt}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>線量：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{WA1070Data?.data.caLgSdBgDs}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>推定濃度：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{WA1070Data?.data.estRa}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>荷姿種別：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0009[WA1070Data?.data.pkTyp as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>内袋利用方法：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0010[WA1070Data?.data.usgInnBg as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>アルミ内袋：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0011[WA1070Data?.data.usgAluBg as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>オーバーパック：</Text></View>
            <View style={styles.tableCell}><Text style={styles.labelText}>{CT0042[WA1070Data?.data.yesNoOP as number]}</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>メモ：</Text></View>
          </View>
          <View style={styles.tableRow}>
            <View style={styles.tableCell}><Text style={styles.labelText}>{WA1070Data?.data.lnkNewTagDatMem}</Text></View>
          </View>
        </View>
      );
    };    
    ...
    const renderOldTag = () => {
      return (
        WA1070Data?.oldTag.oldTagIdList.map((tagId, index) => (
          <View key={index}>
    ...
    return (
      <View style={styles.container}>
        ...
        <View  style={[styles.main]}>
          <Text style={[styles.labelText]}>作業場所：{WA1070Data?.head.wkplcTyp}</Text>
          <Text style={[styles.labelText,styles.labelTextPlace]}>{WA1070Data?.head.wkplc}</Text>
          <Text style={[styles.labelText]}>新タグID：{WA1070Data?.head.newTagId}</Text>
        </View>
