...
import { WA1091BackState,WA1090PrevScreenId,WA1092WtDsState,WA1090NewTagIdState,WA1091OldTagInfoState } from "../atom/atom.tsx";
...
const WA1092 = ({navigation}:Props) => {
    ...
    const btnAppNext = async () => {
      ...
      if(Number(caLgSdBgWt) > Number(settings.kgThresSoil)){
        const result = await showAlert("確認", messages.WA5004(String(settings.kgThresAsh)), true);
        if(!result){
          return;
        }
      }
    ...
    return (
      <View style={styles.container}>
          {/* ヘッダ */}
          <FunctionHeader appType={"現"} viewTitle={"重量・線量"} functionTitle={"紐付(灰)"}/>
            ...
            <View style={styles.middleContainer}>
              <View style={styles.tableMain}>
                ...
                <View style={styles.tableRow}>
                  ...
                  <View style={styles.tableCell}><Text style={styles.inputLabelText}>{WA1091OldTagInfo.meaRa}</Text></View>
                </View>
                <View style={styles.tableRow}>
