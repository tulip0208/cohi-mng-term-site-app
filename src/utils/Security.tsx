 ...
 ************************************************/
 export const atob = (input: string): string => {
  ...
  for (let bc = 0, buffer, idx = 0; buffer = str.charAt(idx++); ~buffer && (bs = bc % 4 ? bs * 64 + buffer : buffer,
 ...
 * @returns 
 ************************************************/
export const encodeToBase64AndReturnAsBinary = (inputString: string): Uint8Array => {
 ...
 * @returns 
 ************************************************/
 export const encodeStringToBase64Binary = (inputString: string): ArrayBuffer => {
  // 文字列をBase64エンコード
  const encodedString = base64.encode(inputString);
 ...
 * @returns 
 ************************************************/
export const decodeBase64BinaryToStringUint8Array = (binaryData: Uint8Array): string => {
 ...
 * @returns 
 ************************************************/
export const decodeBase64BinaryToStringArrayBuffer = (base64BinaryData: ArrayBuffer): string => {
 ...
 * @returns 
 ************************************************/
export const encryptWithAES256CBC = (data: string, secretKey: Uint8Array): string => {
 ...
 * @returns 
 ************************************************/
export const decryptWithAES256CBC = (ciphertext: string, secretKey: Uint8Array): string => {
