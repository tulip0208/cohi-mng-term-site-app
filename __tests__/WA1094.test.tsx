...
jest.mock('../src/utils/Api', () => ({
    IFT0420: jest.fn<Promise<ApiResponse<IFT0420Response<IFT0420ResponseDtl>>>, [WA1090WkPlacConst, WA1091OldTagInfoConst, string, string, WA1092WtDsConst, string, string]>(),
}));
...
describe('WA1094 レンダリング', () => {
    ...
    it('送信プレスイベント', async () => {
        ...
        for (var i = 1; i < 1000; i++) test_text += "本文本文本文";
