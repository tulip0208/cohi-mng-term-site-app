...
const messages = {
    ...
    // --- 2023.12.10 追加 ここから---
    WA5004: (v1) => `重量の入力が${v1}Kgを超過しています。\n間違いがないか確認を行ってください。\n処理を継続しますか？`,
    WA5005: (v1) => `線量の入力が${v1}μSv/hを超過しています。\n間違いがないか確認を行ってください。\n処理を継続しますか？`,
    WA5006: (v1) => `推定放射能濃度が${v1}Bq/kgを超過しています。\n間違いがないか確認を行ってください。`,
    WA5007: () => ``,
    WA5008: (v1) => `${v1}の線量の入力が異常値です。\n間違いがないか確認を行ってください。`,
    WA5009: (v1) => `${v1}が混在しています。\n間違いがないか確認を行ってください。`,
    // --- 2023.12.10 追加 ここまで---
    //error
    ...
    EA5016: (v1) => `読み取ったコードが${v1}ため、追加できません。\nコードが正しいか確認し再度やり直してください。`,
    EA5017: (v1) => `読み込んだコードが新タグIDのコードではありません。\nコードが正しいか確認し再度やり直しを行ってください。\n\n新タグID: ${v1}`,
    EA5018: () => `輸送カードがサーバーに存在しません。\n間違いがないか確認を行ってください。`,
    EA5019: () => `輸送カードの保管場所と作業場所が一致しません。\n間違いがないか確認を行ってください。`,
    EA5020: () => `入力された新タグIDが一致しません。\n新タグIDを再度確認をお願いいたします。`,
    EA5021: (v1) => `線量の入力が${v1}μSv/hを超過しています。\n輸送カード申請を中止します。`,
    EA5022: (v1,v2,v3) => `読み込んだコードが${v1}ではありません。\nコードが正しいか確認し再度やり直しを行うか、${v2}で読み込みを行ってください。\n\n新タグID: ${v3}`,
        // --- 2023.12.10 追加 ここまで---
